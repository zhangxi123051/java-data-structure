...
public class ACAutoMata {
    ...
    private Boolean match (String text) {
        ...
        for(int i = 0; i < n; i++) {
            ...
            while(isNull(p.children.get(c)) && p != root){
                p = p.fail;
            }
    ...
    public static void main(String[] args) {
        ...
        String text2 = "一家总部位于伦敦的公司Fxtex在MWC上就推出了一款名为Fxtec Pro1的手机，" +
                "该机最大的亮点就是采用了侧滑式全键盘设计。" +
                "DxOMark年度总榜发布 华为P20 Pro/谷歌Pixel 3争冠";
